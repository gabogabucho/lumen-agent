"""Personality — who Neo is in this context. Loaded from YAML, swappable by modules."""
...
class Personality:
    """Defines Neo's identity, tone, rules, and domain knowledge for a context.
    ...
    def as_context(self) -> str:
        ...
        lines = [
            f"Your name is {identity.get('name', 'Neo')}.",
