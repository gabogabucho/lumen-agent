...
class TelegramRuntime:
    ...
    async def _handle_update(self, update: dict):
        ...
        # Route to unified inbox → brain → response back via send_message
        inbox = getattr(self.context, "inbox", None)
        ...
        # Fallback: no inbox connected, write to file
...
async def activate(context):
    ...
    if inbox is not None:
        inbox.register_adapter("telegram", runtime.send_message)
    await runtime.start()
    return runtime
